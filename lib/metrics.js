const routeNames = ["/", "/admin", "/catalog", "/config", "/create", "/delete", "/enroll", "/images", "/instances", "/logs", "/metrics", "/order", "/portable-config", "/recreate", "/refresh-hosts", "/registry-webhook", "/report/images", "/restart", "/session/user", "/templates", "/test", "/version", "/webhook", "other"];
...
function routeLabel(req, metrics) {
  ...
  if (requestPath === "/enroll.html") return "/enroll";
  if (requestPath.startsWith("/registry-webhook/")) return "/registry-webhook";
