const routeNames = ["/", "/admin", "/config", "/create", "/delete", "/enroll", "/images", "/instances", "/logs", "/metrics", "/order", "/portable-config", "/recreate", "/refresh-hosts", "/registry-webhook", "/report/images", "/restart", "/session/user", "/templates", "/test", "/version", "/webhook", "other"];
