const routeNames = ["/", "/admin", "/config", "/create", "/delete", "/dockerhub", "/enroll", "/images", "/instances", "/logs", "/metrics", "/order", "/portable-config", "/recreate", "/refresh-hosts", "/report/images", "/restart", "/session/user", "/templates", "/test", "/version", "/webhook", "other"];
