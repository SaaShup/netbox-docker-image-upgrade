...
function createPublicImageAccess({ adminAllowedEmails = [], publicImage = false }) {
  const allowed = adminAllowedEmails.map((email) => String(email).toLowerCase());
